...
//
// Contains the function prototypes for functions that will be defined in proj2.cpp
...
const int V_COMMON = 65;
const int COMMON = 45;
const int UNCOMMON = 25;
const int RARE = 10;
const int U_RARE = 1;

const float HP_RATIO = 0.1; // multiply CP by this to get HP
